...
## 🎯 Problem Statement  
Choosing the right outfit can be difficult due to varying body types, skin tones, and occasions.  
This project aims to simplify fashion decisions using data-driven recommendations.
